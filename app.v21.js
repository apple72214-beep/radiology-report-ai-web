...
import { parseDicom } from "./dicom.v21.js";
import { draftReport } from "./report.v21.js";
import { decodeCompressed } from "./codecs/decode.v21.js";
import { triage as triageCtx } from "./triage.v21.js";
import { buildPackage, validatePackage, downloadJson } from "./consult.v21.js";
...
async function importConsultText(text) {
  let pkg;
  try { pkg = JSON.parse(text); } catch (e) { setStatus("المحتوى ليس JSON صالحًا — رُفض الاستيراد (فشل مغلق).", true); return; }
