...
- قناة ثانية: نسخ الحزمة للحافظة عند التصدير + زر «استيراد من الحافظة» (يلتف على منتقي ملفات أندرويد).
- إزالة فلتر accept من input الملف (بعض منتقيات أندرويد تخفي .json خلف الفلاتر).
- رسائل حالة مرحلية: عند فتح المنتقي، بعد سلامة البصمة، وعند فشل فك اللقطة؛ واسم الملف ضمن رسالة التصدير.
