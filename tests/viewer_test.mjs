import { drawFrame } from "../app.v58.js";
let fails = 0;
...
const src = await import("node:fs").then((fs) => fs.readFileSync(new URL("../app.v58.js", import.meta.url), "utf-8"));
...
ck(src.includes("• v58"), "build tag in meta line");
const ui = await import("node:fs").then((fs) => fs.readFileSync(new URL("../ui.v58.html", import.meta.url), "utf-8"));
...
console.log(fails ? "VIEWER TEST FAIL " + fails : "VIEWER TEST PASS (19)");
