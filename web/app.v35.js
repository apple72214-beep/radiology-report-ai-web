...
const MODULES = [
  ["dicom", "./dicom.v35.js", (m) => { parseDicom = m.parseDicom; }],
  ["report", "./report.v35.js", (m) => { draftReport = m.draftReport; buildSignedDocument = m.buildSignedDocument; }],
  ["decode", "./codecs/decode.v35.js", (m) => { decodeCompressed = m.decodeCompressed; }],
  ["triage", "./triage.v35.js", (m) => { triageCtx = m.triage; }],
  ["consult", "./consult.v35.js", (m) => { buildPackage = m.buildPackage; validatePackage = m.validatePackage; downloadJson = m.downloadJson; }],
  ["docx", "./docx.v35.js", (m) => { buildDocxReport = m.buildDocxReport; }],
  ["measure", "./measure.v35.js", (m) => { segMm = m.segMm; angleDeg = m.angleDeg; ellipseStats = m.ellipseStats; }],
  ["compare", "./compare.v35.js", (m) => { cmpFrameStats = m.frameStats; normalize01 = m.normalize01; diffStats = m.diffStats; frameGrayFlat = m.frameGrayFlat; }],
];
...
export async function refresh() {
  ...
  for (const s of studies) {
    ...
    badge.textContent = s.consult ? "استشارة" : (priority === "urgent" ? "حرج" : "روتيني");
...
function setupConsultUI() {
  ...
  exp.textContent = "تصدير حزمة استشارة";
  ...
  imp.textContent = "استيراد حزمة استشارة";
  const ca = $("clear-all");
