...
const MODULES = [
  ["dicom", "./dicom.v39.js", (m) => { parseDicom = m.parseDicom; parseMultipartRelated = m.parseMultipartRelated; }],
  ["report", "./report.v39.js", (m) => { draftReport = m.draftReport; buildSignedDocument = m.buildSignedDocument; signedDocHash = m.signedDocHash; }],
  ["decode", "./codecs/decode.v39.js", (m) => { decodeCompressed = m.decodeCompressed; }],
  ["triage", "./triage.v39.js", (m) => { triageCtx = m.triage; }],
  ["consult", "./consult.v39.js", (m) => { buildPackage = m.buildPackage; validatePackage = m.validatePackage; downloadJson = m.downloadJson; }],
  ["docx", "./docx.v36.js", (m) => { buildDocxReport = m.buildDocxReport; buildDocxReportEn = m.buildDocxReportEn; }],
  ["measure", "./measure.v39.js", (m) => { segMm = m.segMm; angleDeg = m.angleDeg; ellipseStats = m.ellipseStats; }],
  ["compare", "./compare.v39.js", (m) => { cmpFrameStats = m.frameStats; normalize01 = m.normalize01; diffStats = m.diffStats; frameGrayFlat = m.frameGrayFlat; }],
];
...
function setupPacs() {
  ...
  btn.addEventListener("click", async () => {
    ...
    const relay = (t) => location.origin + "/api/dicomweb?url=" + encodeURIComponent(t);
    try {
      say("استعلام QIDO-RS…");
