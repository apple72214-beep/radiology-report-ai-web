...
import { parseDicom } from "./dicom.v25.js";
import { draftReport, buildSignedDocument } from "./report.v25.js";
import { decodeCompressed } from "./codecs/decode.v25.js";
import { triage as triageCtx } from "./triage.v25.js";
import { buildPackage, validatePackage, downloadJson } from "./consult.v25.js";
import { buildDocxReport } from "./docx.v25.js";
...
function setupSignExport() {
  ...
  $("sign-export-word").addEventListener("click", async () => {
    ...
    setStatus("نزل ملف Word الموقّع: " + el.download + " — بصمة المستند: " + s.doc.hash.slice(0, 16) + "…", false);
  });
}
